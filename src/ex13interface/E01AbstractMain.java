...
/*
 ...
 -인스턴스 생성은 할수없지만 그 외 참조변수선언, 상속등의 모든 기능을
 사용할 수 있다.
...
/*
 ...
 아닌 선택사항이 된다 . 즉 필요한 경우에만 오버라이딩 하면된다.
...
public class E01AbstractMain {
	...
	public static void main(String[] args) {
		...
		/*
		 추상클래스내에 선언된 정적메서드는 오버라이딩의 대상이 될수없으므로
