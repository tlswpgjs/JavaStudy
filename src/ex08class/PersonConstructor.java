...
public class PersonConstructor {
	...
	public PersonConstructor(String name) {
		/*
		 ...
		 클래스 자신, 즉 멤버를 가리킨다. 따라서 좌측함은 멤버변수, 우측함은
		 매개변수가 된다.
		 */
		this.name = name;
		age = 1;
	...
	public PersonConstructor(String name, int age) {
		/*
		 ...
		 단, 생성자 내에서만 사용할 수 있고 일반 멤버메서드에서는 사용할
		 수 없다. 즉, 아래는 매개변수가 3개인 생성자를 호출하는 문장이다.
		 */
		this(name, age, "미상");
	...
	void initialize(String name, int age, String addr) {
		/*
		 ...
		 하지만 멤버메서드는 개발자가 원할때 언제든 호출이 가능하므로 생성자와는
		 특성이 다르다.
