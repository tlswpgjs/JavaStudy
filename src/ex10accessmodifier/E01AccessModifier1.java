...
class DefaultClass1 {
  void myFunc() {
    System.out.println("DefaultClass1클래스의 myFunc()메소드 호출");
  }
}

/*
public 클래스는 해당 java파일을 대표하는 클래스로 파일명과 동일해야하고
또한 public 클래스는 자바 파일당 1개만 정의할 수 있다.
public 으로 지정하는 경우 다른 패키지에서도 접근을 허용하므로, 보통하나의
Java파일에 하나의 클래스만 사용하는것이 원칙이다.
