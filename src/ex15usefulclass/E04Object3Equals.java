...
class MyClass {
	...
	/*
	 toString() : 인스턴스가 가진 데이터를 String으로 변환해준다.
	...
	public boolean equals(Object obj) {
		/*
		 ...
		 이때 전될된 인스턴스가 MyClass타입이 아니라면 비교의 대상이
		 될수없으므로 상속관계 확인을 위해 instanceof 연산자를 사용한다.
		 */
...
public class E04Object3Equals {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 만약 오버라이딩 한 equals를 삭제한 후 실행하면 다른다는 결과가
