...
/*
다형성(Polymorphism)
: 하나의 인스턴스(객체)를 여러 타입의 참조변수를 통해 참조할 떄
참조변수의 타입에 따라 다양한 형태의 인스턴스를 이용할 수 있는 특성을 말한다.
- 부모의 참조변수로 자식 인스턴스를 참조
...
1. 인스턴스 전체에 접근할 수 있다. 즉 클래스이 일반적인 규칙을 따른다.
...
public class E11Polymorphism {
    ...
    public static void main(String[] args) {
        ...
        /*
         * 이질화 : 부모타입의 참조변수로 자식 인스턴스를 참조하는 것을 말한다.
         * 이 경우 자식클래스에서 새롭게 정의한 멤버에는 접근할 수 없다.
         ...
         * 이용해서 우선순위애 대한 부분을 처리해야 에러가 발생하지 않는다.
         * // (MyChild) myParent.childMember = 1;
         * 소괄호를 하나 더 추가해서 myParent를 자식타입으로 형변환 후 멤버변수에
         * 접근해야 한다.
         */
        ((MyChild) myParent).childMember = 1;
        ...
        /*
         * 자식타입으로 형변환 이후에 해당 참조변수를 통해 자식멤버에 접근한다.
         * 위와 동일한 방식이다.
         */
        ...
        /*
         * Java에서 생선한 모든 클래스는 Object 클래스를 상속한다.
